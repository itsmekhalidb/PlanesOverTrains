...
class CTCTrackControllerAPI:
    def __init__(self) -> None:
        ...
        self._maintenance_switch = {"green" : {}, "red" : {}} # green, red lines with {switch name: position}
        ...
        self._train_in = {}  # train id : [actual velocity (m/s), occupied block, cum_distance, line]
        self._curr_speed = {}
