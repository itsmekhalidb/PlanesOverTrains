...
"border: 3px solid black;")
        ...
        self.track_status_comboBox.addItem("")
        self.track_status_comboBox.addItem("")
        self.track_status_comboBox.addItem("B-B6")
        self.track_status_comboBox.addItem("B-B7")
        self.track_status_comboBox.addItem("B-B8")
        self.track_status_comboBox.addItem("B-B9")
        self.track_status_comboBox.addItem("B-B10")
        self.track_status_comboBox.addItem("B-C11")
        self.track_status_comboBox.addItem("B-C12")
        self.track_status_comboBox.addItem("B-C13")
        self.track_status_comboBox.addItem("B-C14")
        self.track_status_comboBox.addItem("B-C15")
    ...
    def retranslateUi(self, Frame):
        ...
        self.block_comboBox.setItemText(0, _translate("Frame", "B-A1"))
        self.block_comboBox.setItemText(1, _translate("Frame", "B-A2"))
        self.block_comboBox.setItemText(2, _translate("Frame", "B-A3"))
        self.block_comboBox.setItemText(3, _translate("Frame", "B-A4"))
        self.block_comboBox.setItemText(4, _translate("Frame", "B-A5"))
        self.block_comboBox.setItemText(5, _translate("Frame", "B-B6"))
        self.block_comboBox.setItemText(6, _translate("Frame", "B-B7"))
        self.block_comboBox.setItemText(7, _translate("Frame", "B-B8"))
        self.block_comboBox.setItemText(8, _translate("Frame", "B-B9"))
        self.block_comboBox.setItemText(9, _translate("Frame", "B-B10"))
        self.block_comboBox.setItemText(10, _translate("Frame", "B-C11"))
        self.block_comboBox.setItemText(11, _translate("Frame", "B-C12"))
        self.block_comboBox.setItemText(12, _translate("Frame", "B-C13"))
        self.block_comboBox.setItemText(13, _translate("Frame", "B-C14"))
        self.block_comboBox.setItemText(14, _translate("Frame", "B-C15"))
        ...
        self.switch_comboBox.setItemText(0, _translate("Frame", "B-BC-A"))
        ...
        self.light_color_comboBox.setItemText(0, _translate("Frame", "B-A5 Out"))
        self.light_color_comboBox.setItemText(1, _translate("Frame", "B-B6"))
        self.light_color_comboBox.setItemText(2, _translate("Frame", "B-C11"))
        ...
        self.track_status_comboBox.setItemText(0, _translate("Frame", "B-A1"))
        self.track_status_comboBox.setItemText(1, _translate("Frame", "B-A2"))
        self.track_status_comboBox.setItemText(2, _translate("Frame", "B-A3"))
        self.track_status_comboBox.setItemText(3, _translate("Frame", "B-A4"))
        self.track_status_comboBox.setItemText(4, _translate("Frame", "B-A5"))
        self.track_status_comboBox.setItemText(5, _translate("Frame", "B-B6"))
        self.track_status_comboBox.setItemText(6, _translate("Frame", "B-B7"))
        self.track_status_comboBox.setItemText(7, _translate("Frame", "B-B8"))
        self.track_status_comboBox.setItemText(8, _translate("Frame", "B-B9"))
        self.track_status_comboBox.setItemText(9, _translate("Frame", "B-B10"))
        self.track_status_comboBox.setItemText(10, _translate("Frame", "B-C11"))
        self.track_status_comboBox.setItemText(11, _translate("Frame", "B-C12"))
        self.track_status_comboBox.setItemText(12, _translate("Frame", "B-C13"))
        self.track_status_comboBox.setItemText(13, _translate("Frame", "B-C14"))
        self.track_status_comboBox.setItemText(14, _translate("Frame", "B-C15"))
...
if __name__ == "__main__":
    ...
    ui = Ui_TrackController_Testbench()
    ui.setupUi(Frame)
    Frame.show()
    sys.exit(app.exec_())
