...
"border: 3px solid black;")
        ...
        self.block_comboBox.addItem("")
        self.block_comboBox.addItem("")
        self.toggle_occupancy_button = QtWidgets.QPushButton(Frame, clicked=lambda:self.track_controller.set_occupancy(self.block_comboBox.currentText(), not self.track_controller.get_occupancy(self.block_comboBox.currentText())))
